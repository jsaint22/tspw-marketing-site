...
**The duty-day allocation is accepted without challenge.** The duty-day method is the standard in the United States, and the main alternative has been successfully challenged — the Ohio Supreme Court struck down Cleveland's games-played method in *Hillenmeyer v. Cleveland* (2015) as a violation of due process. Allocation is still worth checking jurisdiction by jurisdiction rather than total duty days, which can produce a more favorable result depending on the schedule. An advisor who understands jock tax mechanics can evaluate which method produces the best outcome in each jurisdiction.
